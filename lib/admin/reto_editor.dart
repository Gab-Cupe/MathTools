...
class _RetoEditorScreenState extends State<RetoEditorScreen> {
  final DatabaseReference _retoRef = FirebaseDatabase.instance.ref(
    'retos/problema_del_dia',
  );
        ...
        child: Column(
          children: [
            _buildTextField(
              'Apartado',
              _retoData['apartado'] ?? '',
              (value) => _retoData['apartado'] = value,
            ),
            const SizedBox(height: 16),
            _buildTextField(
              'Premisa',
              _retoData['premisa'] ?? '',
              (value) => _retoData['premisa'] = value,
              maxLines: 5,
            ),
            const SizedBox(height: 16),
            _buildImageUploader(),
            ...
            _buildTextField(
              'Solución',
              _retoData['solucion'] ?? '',
              (value) => _retoData['solucion'] = value,
              maxLines: 5,
            ),
