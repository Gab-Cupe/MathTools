...
class RetoDesignDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor =
        Colors.blue.shade700; // Color primario azul profesional
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          splashRadius:
              20, // Reduce el área de splash para que sea más elegante
          onPressed: () => Navigator.pop(context),
        ),
        title: Container(
          margin: const EdgeInsets.only(
            right: 20,
          ), // Compensa el espacio del botón de retroceso
          child: Row(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 24),
                            if (reto.imagenUrl != null &&
                                reto.imagenUrl!.isNotEmpty)
                              Column(
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        respuestaCorrecta
                                            ? puntosOtorgados
                                                  ? '✅ Ganaste ${reto.puntosRecompensa} puntos'
                                                  : '✅ Respuesta correcta'
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.separated(
                              itemCount: reto.opciones.length,
                              separatorBuilder: (_, _) =>
                                  const SizedBox(height: 12),
                              itemBuilder: (context, index) {
                                final entry = reto.opciones.entries.elementAt(
                                  index,
                                );
                                return Container(
                                  decoration: BoxDecoration(
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed:
                                  (opcionSeleccionada == null || mismoDia)
                                  ? null
                                  : onVerSolucion,
