...
class ExerciseDesignDesktop extends StatelessWidget {
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [const Color(0xFF0924AA), Colors.blue.shade700],
              stops: const [0.3, 1.0],
            ),
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 24),
                            if (exercise.imagenUrl != null &&
                                exercise.imagenUrl!.isNotEmpty)
                              Column(
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.separated(
                              itemCount: exercise.opciones.length,
                              separatorBuilder: (_, _) =>
                                  const SizedBox(height: 12),
                              itemBuilder: (context, index) {
                                final entry = exercise.opciones.entries
                                    .elementAt(index);
                                return Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(12),
          ...
          Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: currentIndex > 0 ? () => onPreviousPressed() : null,
